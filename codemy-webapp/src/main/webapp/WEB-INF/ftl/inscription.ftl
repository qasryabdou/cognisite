        ...
        <div class="content-wrapper rounded">
            ...
            <div class="content">
                ...
                <div class="inscription-bloc-g">
                    ...
                    <div class="entreeformulaire">
                        <div class="entetechamp">
                            <label for="inscription.nom">Nom<sup class="requiredstar">*</sup>:
                            </label></div>
                        <div class="fields">
	                            <input class="required" id="inscription.nom" name="inscription.nom" value="" type="text" value="" size="30"/>                         	
                        </div>
                ...
                <div class="inscription-bloc-d">
                    <div class="entreeformulaire">
                        ...
                        <div class="fields">
                            <input class="required NumbersOnly"  id="mobile" name="mobile" type="text" value="" size="30"/></div>
                    </div>
                    <div class="entreeformulaire">
                        <div class="entetechamp">
